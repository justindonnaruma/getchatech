...
// GOOGLE MAP
var $googlemap_latitude = 44.513002,
    $googlemap_longitude = -70.462403,
    $googlemap_zoom = 13;
...
function _topNav() {
    ...
    function topMain() {
        ...
        if (_scrollTop > 0) {
            ...
            jQuery('header#topNav a.logo, #buyNow').stop().animate({ 'line-height': '0', 'margin-top': '-7px'}, 400);
            jQuery('#header_shadow').stop().animate({ 'top': '30px'}, 400);
            /* just a little visible */
            jQuery('#buyNow img').stop().animate({ 'height': '43px'}, 400);
        ...
        if (window.topNavSmall === true && _scrollTop < 3) {
            ...
            jQuery('header#topNav a.logo, #buyNow').stop().animate({ 'line-height': '50px', 'margin-top': '0'}, 400);
            jQuery('#header_shadow').stop().animate({ 'top': '92px'}, 400);
            jQuery('#buyNow img').stop().animate({ 'height': '61px'}, 400);
            window.topNavSmall = false;
        }
...
/** 11. Background Image
 ...
 Add to body - example: data-background="/images/boxed_background/1.jpg"
 **************************************************************** **/
function _bgimage() {
...
(function() {
    ...
    po.src = "https://apis.google.com/js/plusone.js?publisherid=113903137272182221529";
...
ga('create', 'UA-48081821-1', 'rumatec.us');
ga('send', 'pageview');